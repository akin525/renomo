                                            ...
                                            <div class="white_shd full margin_bottom_30">
                                                <div class="full graph_head">
                                                    <div class="heading1 margin_0">
                                                        <h2 class="text-success"><b>{{\App\Console\encription::decryptdata($re['username'])}}</b></h2>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="progress_bar">
                                                                <!-- Skill Bars -->
                                                                <span class="skill" style="width: 80%;">Total Safelock<span class="info_valume">₦{{number_format(intval($re->amount *1))}}</span></span>
                                                                <div class="progress skill-bar ">
                                                                    <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" aria-valuenow="{{$re->amount}}" aria-valuemin="0" aria-valuemax="1000" style="width: 100%;">
                                                                    </div>
                                                                </div>
                                                                <span class="skill" style="width:80%;">Count<span class="info_valume">{{$re->count}}</span></span>
                                                                <div class="progress skill-bar ">
                                                                    <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" aria-valuenow="{{$re->count}}" aria-valuemin="0" aria-valuemax="1000" style="width: {{$re->count}}%;">
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <center>
