                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mt-2">
                                ...
                                <input style="margin-right: 20px" type="text" name="status" value=""  id="po" readonly class="form-control @error('status') is-invalid @enderror">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa fa-couch"></i></span>
                                </div>
                                <input type="number" name="limit" placeholder="Enter Your giveaway limit" class="form-control @error('wallet') is-invalid @enderror">
                            </div>
