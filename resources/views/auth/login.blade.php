                            ...
                            <fieldset>
                                ...
                                <center>
                                    <div class="field">
                                        ...
                                        <br>
                                        <center>
                                            <a  onclick="web2app.biometric.check(myCallback);"><h3 class="text-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-fingerprint" viewBox="0 0 16 16">
                                                    ...
                                                    </svg>Fingerprint</h3>Login With </a>
                                        </center>
                                        <script>
