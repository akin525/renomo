    ...
    public function vertual(Request $request)
    {
        if (Auth::check()) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://app.mcd.5starcompany.co0.m.ng/api/reseller/virtual-account',
                ...
                CURLOPT_POSTFIELDS => array('account_name' => 'yellowmantech', 'business_short_name' => 'RENO', 'uniqueid' => 'yellowman', 'email' => 'info@yellowmantelecoms.com.ng', 'phone' =>'08111111111', 'webhook_url' => 'https://renomobilemoney.com/api/run',),
