    ...
    public function vertual(Request $request)
    {
        if (Auth::check()) {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => array('account_name' => $name, 'business_short_name' => 'RENO', 'uniqueid' => $username, 'email' => 'info@yellowmantelecoms.com.ng', 'phone' =>$phone, 'webhook_url' => 'https://renomobilemoney.com/api/run',),
